...
\title{Identifying Regulation of Metabolism and Protein Expression Using Integrative `Omics}

\submitted{January 2016}  % degree conferral date (January, April, June, September, or November)
...
%\includeonly{ch-quant_anal/quant_analysis, ch-intro/chapter-intro, ch-pt_compare/PTA}
%\includeonly{ch-conclusion/chapter-conclusion, ch-intro/chapter-intro}
%%% You can also specify multiple chapters.
%\includeonly{ch-pt_compare/PTA}
%\includeonly{ch-simmer/rOCA}
...
\include{ch-quant_anal/quant_analysis}
\include{ch-simmer/rOCA}
\include{ch-pt_compare/PTA}
\include{ch-conclusion/chapter-conclusion}
\appendix % all chapters following will be labeled as appendices
\include{ch-appendicies/proteomicsEM}
